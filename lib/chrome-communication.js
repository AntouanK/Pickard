...
API.openSocket = function(thisRoboChrome, wsURL){

  if(thisRoboChrome === undefined){
    throw new Error('no RoboChrome instance given');
  }
  ...
  thisRoboChrome.ws = ws;
  thisRoboChrome.write = write;
  ...
  ws.on('open', function open() {
    ...
    thisRoboChrome.evaluate = function(expression){
